...
public class A_Lambdas {
    ...
    public void a_predicate1() {
        Predicate<String> pred = str -> str.length() > 4; // TODO
    ...
    public void b_function1() {
        Function<String, String> func = str -> String.format("(%s)", str); // TODO
    ...
    public void b_function3() {
        Function<String, String> func = str -> str.toUpperCase(); // TODO
    ...
    public void c_consumer3() {
        Consumer<List<String>> cons = list -> list.clear(); // TODO
    ...
    public void e_bifunction1() {
        BiFunction<String, String, String> bifunc = (first, second) -> String.format("%s%s%s", first, second, first); // TODO
    ...
    public void e_bifunction2() {
        BiFunction<String, String, Integer> bifunc = (first, second) -> first.indexOf(second); // TODO
    ...
    public void g_boundMethodRef1() {
        Function<String, Integer> func = str -> "abcdefghij".indexOf(str); // TODO
